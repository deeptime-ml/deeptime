...
from deeptime.plots import plot_markov_model, Network
...
axes[0].set_title('Plotting the Markov model')
plot_markov_model(P, ax=axes[0])

axes[1].set_title('Plotting the gross flux')
