...
def read_discrete_trajectory(filename):
    ...
    >>> from sktime.markov.tools.dtraj import write_discrete_trajectory, read_discrete_trajectory
...
def load_discrete_trajectory(filename):
    ...
    >>> import os
    >>> from tempfile import mktemp
    >>> from sktime.markov.tools.dtraj import load_discrete_trajectory, save_discrete_trajectory
