...
:class:`HMMs <sktime.markovprocess.hmm.HiddenMarkovStateModel>` is likely to
...
For a HMM with a :class:`discrete output model <sktime.markovprocess.hmm.DiscreteOutputModel>`, the following main
steps are involved:

1. A :class:`markov state model <sktime.markovprocess.msm.MarkovStateModel>` is estimated from given discrete
...
For a HMM with a :class:`gaussian output model <sktime.markovprocess.hmm.GaussianOutputModel>`, a Gaussian mixture
