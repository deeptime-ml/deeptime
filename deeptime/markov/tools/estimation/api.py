...
def count_matrix(dtraj, lag, sliding=True, sparse_return=True, nstates=None):
    ...
    nstates : int, optional
        Enforce a count-matrix with shape=(n_markov_states, n_markov_states)
    ...
    **Lag**
    ...
    seperated form the last point by less than the given lag_time
    :math:`\tau`.
    ...
    **Sliding**
    ...
    transitions sperated by the lag_time :math:`\tau`.
...
def bootstrap_counts(dtrajs, lagtime, corrlength=None):
    ...
    corrlength : int, optional, default=None
        ...
        where N is the total number of frames. If set to None (default), corrlength = lag_time will be used.
    ...
    The bootstrap will be generated by sampling N/corrlength counts at time tuples (t, t+lag_time),
    where t is uniformly sampled over all trajectory time frames in [0,n_i-lag_time].
